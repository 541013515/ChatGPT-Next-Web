...
const it: LocaleType = {
  ...
  Home: {
    ...
    Revert: "Revert",
    Title: "assistente di intelligenza artificiale",
    Description: "Creare il tuo assistente AI personalizzato",
  },
  Settings: {
    Title: "Impostazioni",
    ...
    Contact: {
      Title: "Contattami",
      SubTitle: "Se hai bisogno di un sito web personalizzato, contattami",
    },
    WeChat: "Account Ufficiale di WeChat",
  },
  Store: {
